...
3. **Serviços/áreas de atuação**: cards clicáveis — cada card leva à âncora da seção detalhada ou direto ao WhatsApp com mensagem pré-preenchida (`https://wa.me/[whatsapp do lead, já no formato internacional coletado na prospecção — 55DDDNUMERO no Brasil, 351NUMERO em Portugal]?text=Olá! Vim pelo site e quero saber sobre [serviço]`).
...
- [ ] Número do WhatsApp no formato wa.me correto (55 + DDD + número no Brasil, 351 + número em Portugal — usar o valor já capturado na prospecção, nunca reformatar)
