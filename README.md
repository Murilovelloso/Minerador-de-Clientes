...
| `/publicar` | Publica no VPS SOZINHO via SSH (publicador automático, chave — sem senha) + página-capa da proposta + HTTPS validado |
...
**No Claude Code:**
```
/plugin marketplace add Murilovelloso/Minerador-de-Clientes
/plugin install prospector-de-sites@murilove-plugins
```
...
```
/plugin marketplace update murilove-plugins
```
...
Claude Cowork · extensão Claude in Chrome · conectores Gmail e Google Drive · VPS próprio com SSH (nginx/Apache + certbot) · Python (para o dashboard e o publicador) · Windows ou Mac.
...
Feito por **Murilove** · [Instagram @eusoumurilove](https://instagram.com/eusoumurilove)
